...
const ErrorModal: React.FC<ErrorModalProps> = ({ error, onClose }) => {
  return (
    ...
    >
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gray-100 z-50 max-h-[80vh] w-[90%] tablet:w-[50%] laptop-l:w-[40%] overflow-hidden rounded-xl text-[1.2rem] p-4 flex flex-col items-center gap-5 shadow-lg">
